    ...
    public class CarAudio : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            if (m_StartedSound)
            {
                ...
                float pitch = ULerp(lowPitchMin, lowPitchMax, m_CarControl.Revs);
                ...
                else
                {
                    ...
                    float accFade = Mathf.Abs(m_CarControl.AccelInput);
                    float decFade = 1 - accFade;

                    // get the high fade value based on the cars revs
                    float highFade = Mathf.InverseLerp(0.2f, 0.8f, m_CarControl.Revs);
