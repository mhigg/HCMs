...
namespace UnityStandardAssets.Vehicles.Car
{
    ...
    public class CarAIPoint : MonoBehaviour
    {
        ...
        private void FixedUpdate()
        {
            ...
            else
            {
                ...
                if (m_Rigidbody.velocity.magnitude > m_CarController.MaxSpeed[m_CarController.CurrentGearNum] * 0.1f)
                {
                    fwd = m_Rigidbody.velocity;
                }

                float desiredSpeed = m_CarController.MaxSpeed[m_CarController.CurrentGearNum];
                ...
                desiredSpeed = Mathf.Lerp(m_CarController.MaxSpeed[m_CarController.CurrentGearNum], m_CarController.MaxSpeed[m_CarController.CurrentGearNum] * m_CautiousSpeedFactor,
        ...
        private void OnCollisionStay(Collision col)
        {
            ...
            {
                var otherAI = col.rigidbody.GetComponent<CarAIPoint>();
                if (otherAI != null)
                {
